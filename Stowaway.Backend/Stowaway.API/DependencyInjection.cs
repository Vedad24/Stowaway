...
public static class DependencyInjection
{
        ...
        IHostEnvironment env)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Stowaway API", Version = "v1" });
            var xml = Path.Combine(AppContext.BaseDirectory, "Stowaway.API.xml");
            if (File.Exists(xml))
        ...
        services.AddExceptionHandler<StowawayExceptionHandler>();
