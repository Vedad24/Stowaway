using Stowaway.API;
using Stowaway.API.Middleware;
using Stowaway.Application;
using Stowaway.Infrastructure;
...
public partial class Program
{
    private static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            Log.Information("Stowaway API started successfully.");
            app.Run();
        }
        ...
        catch (Exception ex)
        {
            ...
            Log.Fatal(ex, "Stowaway API terminated unexpectedly.");
        }
        finally
        {
