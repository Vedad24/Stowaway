...
namespace Stowaway.Infrastructure.Migrations
{
    ...
    [Migration("20260906213913_AddItemUserFavourite")]
    partial class AddItemUserFavourite
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stowaway.Domain.Entities.Identity.RefreshTokenEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stowaway.Domain.Entities.Identity.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stowaway.Domain.Entities.Sales.CartItemEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stowaway.Domain.Entities.Sales.ProcessedStripeEventEntity", b =>
                {
                    ...
                    b.ToTable("ProcessedStripeEvent", "Sales");
                });
            ...
            modelBuilder.Entity("Stowaway.Domain.Entities.Storage.Item_UserFavouriteEntity", b =>
                {
                    b.Property<int>("ItemId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Item_UserFavourite", "Storage");
                });
            ...
            modelBuilder.Entity("Stowaway.Domain.Entities.Identity.RefreshTokenEntity", b =>
                {
                    b.HasOne("Stowaway.Domain.Entities.Identity.UserEntity", "User")
